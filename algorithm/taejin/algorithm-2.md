...
3. 진입 차수가 0인 노드(선행 조건이 없는 작업)를 찾아서 **큐(Queue)**에 넣습니다.

4. 큐에서 노드를 하나 꺼내서 "완료" 처리(결과 리스트에 추가)합니다.

5. 완료된 노드와 연결된 화살표(간선)를 모두 끊습니다.

6. 이때, 연결되어 있던 다음 노드들의 진입 차수를 1씩 줄입니다.

7. 새롭게 진입 차수가 0이 된 노드가 있다면 큐에 넣습니다.

8. 큐가 빌 때까지 3~5번을 반복합니다.
